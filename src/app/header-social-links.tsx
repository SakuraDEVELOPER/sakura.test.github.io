...
function DiscordIcon() {
  return (
    <svg
      ...
      preserveAspectRatio="xMidYMid meet"
      aria-hidden="true"
      className={`${ICON_BASE_CLASS} relative top-[0.5px] h-[16px] w-[16px]`}
    >
      ...
      <div className="flex items-center gap-2.5 rounded-[18px] border border-[#3a2329] bg-[#120d10] px-4 py-2.5 shadow-[0_0_24px_rgba(255,183,197,0.08)]">
        {SOCIAL_LINKS.map((link) => {
          const commonClassName =
            "inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-md align-middle text-[#ffb7c5] transition duration-200";
